    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orders', to='bangazonapp.Customer')),
            ],
            options={
                'verbose_name': 'order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(height_field=75, upload_to='.static/media', width_field=75)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='payment', to='bangazonapp.Customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orderproducts', to='bangazonapp.Order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orderproducts', to='bangazonapp.Product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orders', to='bangazonapp.Payment'),
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
